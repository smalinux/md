...
| `[b`         | Prev Buffer                 | **n** | -    |                               |
| `[B`         | Move buffer prev            | **n** | -    | change it to ctrl+shitt+B (?) |
| `]b`         | Next Buffer                 | **n** | -    |                               |
...
| Key               | Description                             | Mode  |     |
| ----------------- | --------------------------------------- | ----- | --- |
| `<leader><space>` | Find Files (current project)            | **n** | ⭐   |
| `<leader>,`       | Buffers                                 | **n** | ⭐   |
| `<leader>/`       | Grep (Root Dir)                         | **n** | ⭐   |
| `<leader>:`       | Command History                         | **n** | ⭐   |
| `<leader>e`       | Explorer Snacks (root dir)              | **n** | ⭐   |
| `<leader>E`       | Toggle Neo-tree (focus on current file) | **n** | ⭐   |
| `<leader>ff`      | Files                                   | **n** |     |
| `<leader>fp`      | Projects                                | **n** |     |
| `<leader>fr`      | Recent                                  | **n** | ⭐   |
| `<leader>fR`      | Recent (current project)                | **n** |     |
| `<leader>g`       | Git                                     | **n** |     |
| `<leader>s`       | Search                                  | **n** |     |
...
- [ ] https://github.com/folke/lazy.nvim
	...
	- [ ] https://github.com/wezterm/wezterm جامد حلوف
...
.
اقفل كل الـ shortcuts اللى مسحتها من الـ cheatsheet بتاعك
علشان ما تدوسش عليهم بالغلط
.
____
الناس اتجننت https://dotfyle.com/
___
